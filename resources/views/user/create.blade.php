        ...
        <div class="container-fluid">
          ...
          <div class="row">
                <form action="{{ route('user.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" value="{{ old('password_confirmation') }}" name="password_confirmation" class="form-control" placeholder="Подтвердите пароль">
                    </div>
                    <div class="form-group">
                        <input type="text" value="{{ old('surname') }}" name="surname" class="form-control" placeholder="Номер тел.">
                    </div>
                    <div class="form-group">
                        <input type="text" value="{{ old('patronymic') }}" name="patronymic" class="form-control" placeholder="Статус заказа">
                    </div>
                    <div class="form-group">
