                                            ...
                                            <div v-for="product in products" class="col-xl-4 col-lg-6 col-6 ">
                                                <div class="products-three-single w-100  mt-30">
                                                    <div class="products-three-single-img">
                                                        ...
                                                        </div> <a @click.prevent="addToCart(product, true)" href="cart.html"
                                                    ...
                                                    <div :id="`popup${product.id}`" class="product-gird__quick-view-popup mfp-hide">
                                                        <div v-if="popupProduct" class="container">
                                                            <div class="row justify-content-between align-items-center">
                                                                <div class="col-lg-6">
                                                                    <div class="quick-view__left-content" v-if="popupProduct.product_images.length > 1">
                                                                        <div class="tabs">
                                                                            <div class="popup-product-thumb-box">
                                                                                <!-- список изображений левой части popup -->
                                                                                <ul>
                                                                            ...
                                                                            <div class="popup-product-main-image-box">
                                                                                <!-- список главных изображений popup -->
                                                                    ...
                                                                    <div class="popup-right-content">
                                                                        ...
                                                                        <div class="price">
                                                                            <h2> {{  popupProduct.price  }}
                                                                                <!-- если товар по скидке
                                                                                    <del> $65 USD</del>
                                                                                 -->
                                                                            </h2>
                                                                            <!-- Если вещь в наличии count>=1 -->
                                                                            <h6> In stuck</h6>
                                                                        </div>
                                                                        <!-- Группы -->
                                                                        <div class="color-varient">
                                                                            <template v-for="groupProduct in popupProduct.group_products">
                                                                                <a @click.prevent="getProduct(groupProduct.id)" v-for="color in groupProduct.colors" href="#0"
                                                    ...
                                                    <div class="products-three-single-content text-center"> <span> {{ product.category.title }} </span>
                                                        ...
                                                        <p>
                                                        <!-- optionally, you can add the old price <del>$200.00 </del> -->
                                                        {{ product.price }} ₽
                                                        </p>
                                                    </div>
                                                </div>
